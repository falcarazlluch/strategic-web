  ...
  en: {
    ...
    pricing: {
      ...
      plans: [
        ...
        {
          name: 'Plus',
          description: 'For teams that run strategy on a regular cadence.',
          price: 299,
          currency: '€',
          period: '/ month',
          tokens: '~75K tokens / month',
          cta: 'Start Now',
          ctaVariant: 'outline' as const,
          featured: false,
          badge: null,
        ...
        {
          name: 'Premium',
          description: 'For power users who demand AI-grade speed and depth.',
          price: 599,
          currency: '€',
          period: '/ month',
          tokens: '~300K tokens / month',
          cta: 'Start Now',
          ...
          features: [
            ...
            'Everything in Plus',
            'Conversational report editing',
            'AI agent for in-depth refinement',
            'Priority server processing',
        ...
        {
          name: 'Enterprise',
          description: 'For organizations deploying strategic AI at scale.',
          price: null,
          currency: '€',
          period: '',
  ...
  es: {
    ...
    pricing: {
      ...
      plans: [
        ...
        {
          name: 'Plus',
          description: 'Para equipos que gestionan la estrategia de forma regular.',
          price: 299,
          currency: '€',
          period: '/ mes',
          tokens: '~75K tokens / mes',
          cta: 'Empieza Ahora',
          ctaVariant: 'outline' as const,
          featured: false,
          badge: null,
          ...
          notIncluded: [
            'Edición conversacional con agente IA',
            'Priorización en servidor',
            'Acceso API',
          ],
        },
        {
          name: 'Premium',
          description: 'Para usuarios exigentes que necesitan velocidad y profundidad de IA.',
          price: 599,
          currency: '€',
          period: '/ mes',
          tokens: '~300K tokens / mes',
          cta: 'Empieza Ahora',
          ctaVariant: 'primary' as const,
          featured: true,
          badge: 'Más Potente',
          features: [
            ...
            'Edición conversacional de informes',
            'Agente IA para refinamiento profundo',
            'Priorización en elaboración de informes',
            'Exportación PDF, Word y PowerPoint',
            'Soporte dedicado',
          ],
          notIncluded: [
            'Acceso API',
        ...
        },
        {
          ...
          currency: '€',
          period: '',
          tokens: 'Asignación de tokens personalizada',
