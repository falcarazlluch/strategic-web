  ...
  en: {
    ...
    pricing: {
      ...
      plans: [
        ...
        {
          name: 'Agency',
          description: 'For teams needing more than 30 reports/month. Includes everything in Premium, with volume and capabilities tailored to your operation.',
          price: null,
          currency: '€',
          period: '',
          tokens: 'Custom volume · Team',
          cta: 'Contact us',
          ctaVariant: 'outline' as const,
          featured: false,
          badge: null,
          features: [
            'Custom report volume (above 30/month)',
            'Multi-user team workspace',
            'Role-based access (Owner / Admin / Analyst)',
          ],
          notIncluded: [],
  ...
  es: {
    ...
    pricing: {
      ...
      plans: [
        ...
        {
          name: 'Agency',
          description: 'Para equipos que necesitan más de 30 informes/mes. Incluye todo lo del plan Premium, con volumen y capacidades adaptadas a tu operación.',
          price: null,
          currency: '€',
          period: '',
          tokens: 'Volumen a medida · Equipo',
          cta: 'Contáctanos',
          ctaVariant: 'outline' as const,
          featured: false,
          badge: null,
          features: [
            'Volumen de informes a medida (más de 30/mes)',
            'Equipo multi-usuario',
            'Acceso por roles (Owner / Admin / Analista)',
          ],
          notIncluded: [],
