  ...
  en: {
    ...
    pricing: {
      ...
      plans: [
        ...
        {
          name: 'Agency',
          description: 'Need more than 30 reports/month? Tell us your case and we\'ll tailor a plan for you.',
          price: null,
          currency: '€',
          period: '',
          tokens: 'Custom volume',
          cta: 'Contact us',
          ctaVariant: 'outline' as const,
          featured: false,
          badge: null,
  ...
  es: {
    ...
    pricing: {
      ...
      plans: [
        ...
        {
          name: 'Agency',
          description: '¿Necesitas más de 30 informes/mes? Cuéntanos tu caso y lo adaptamos a ti.',
          price: null,
          currency: '€',
          period: '',
          tokens: 'Volumen a medida',
          cta: 'Contáctanos',
          ctaVariant: 'outline' as const,
          featured: false,
          badge: null,
